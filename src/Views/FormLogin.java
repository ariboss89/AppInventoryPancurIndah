...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        role = cbRole.getSelectedItem().toString().trim();

        if (txtUsername.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Silahkan Isi Field Username !!");
            txtUsername.requestFocus();
        } else if (txtPassword.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Silahkan Isi Field Password !!");
            ...
            try {
                ...
                rs = st.executeQuery("select *from tb_pengguna where username ='" + username + "' And password = '" + password + "' AND role = '" + role + "'");
                if (rs.next()) {
